...
public class GUIs {
    ...
    static public void alert(Context context,String msg){
        alert(context,null,msg,context.getString(Res.string.cact_ok),NO_ICON_RES);
    }
    
    static public void alert(Context context,int msg){
        alert(context,null,context.getString(msg),context.getString(Res.string.cact_ok),NO_ICON_RES);
    }
    
    static public void confirm(Context context,int msg,OnFinishListener listener){
        confirm(context,null,context.getString(msg),context.getString(Res.string.cact_ok),context.getString(Res.string.cact_cancel),NO_ICON_RES,listener);
    }
    
    static public void confirm(Context context,String msg,OnFinishListener listener){
        confirm(context,null,msg,context.getString(Res.string.cact_ok),context.getString(Res.string.cact_cancel),NO_ICON_RES,listener);
    }
    ...
    static public void errorToast(Context context,Throwable e){
        shortToast(context,context.getString(Res.string.cmsg_error,e.getMessage()));
    }
    
    static public void error(Context context,Throwable e){
        alert(context,context.getString(Res.string.cmsg_error,e.getMessage()));
    }
    ...
    static public void doBusy(Context context,Runnable r){
        doBusy(context,context.getString(Res.string.cmsg_busy),r); 
    }
