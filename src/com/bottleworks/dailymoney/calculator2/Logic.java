...
class Logic {
    ...
    static public final char MINUS = '\u2212';

    private final String mErrorString;

    Logic(Context context, History history, CalculatorDisplay display, Button equalButton) {
        mErrorString = context.getResources().getString(Res.string.cal2_error);
        try {
        ...
        mEnterString = context.getText(Res.string.cal2_enter).toString();
    ...
    /* add by dennis */
    public void setNumbericResult(String result) {
        if(result.equals("0")){
            result = "";
        }
        mResult = "";
