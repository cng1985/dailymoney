...
class HistoryAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view;
        if (convertView == null) {
            view = mInflater.inflate(Res.layout.cal2_history_item, parent, false);
        } else {
            view = convertView;
        }

        TextView expr   = (TextView) view.findViewById(Res.id.cal2_historyExpr);
        TextView result = (TextView) view.findViewById(Res.id.cal2_historyResult);
