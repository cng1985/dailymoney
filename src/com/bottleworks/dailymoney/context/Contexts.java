...
public class Contexts {
    ...
    //analytics code
    private static final String ANALYTICS_CDOE = "UA-26208428-1";
            ...
            trackSingleExecutor.submit(new Runnable() {
                public void run() {
                    try {
                        ...
                        tracker.setProductVersion(i18n.string(Res.string.app_surface), getApplicationVersionName());
    ...
    public boolean shareContent(String subject,String content,boolean htmlContent,List<File> attachments){
        ...
        try{
            uiActivity.startActivity(Intent.createChooser(intent, i18n.string(Res.string.clabel_share)));
        }catch(Exception x){
    ...
    private void initMasterDataProvider(Context context) {
        ...
        if(book==null){
            String name = i18n.string(Res.string.title_book)+sbid;
            book = new Book(name,i18n.string(Res.string.label_default_book_symbol),SymbolPosition.FRONT,"");
