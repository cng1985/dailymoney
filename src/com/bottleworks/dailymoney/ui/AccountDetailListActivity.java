...
public class AccountDetailListActivity extends ContextsActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(Res.layout.accdetlist);
        initialIntent();
        initialContent();
    ...
    private void initialIntent() {
        ...
        info = info + i18n.string(Res.string.label_accdetlist_dateinfo,fromStr,toStr); 
    ...
    private void initialContent() {
        ...
        detailListHelper = new DetailListHelper(this, i18n,calHelper,true,new DetailListHelper.OnDetailListener() {
            ...
            public void onDetailDeleted(Detail detail) {
                GUIs.shortToast(AccountDetailListActivity.this, i18n.string(Res.string.msg_detail_deleted));
                reloadData();
                setResult(RESULT_OK);
            }
        });
        
        infoView = (TextView)findViewById(Res.id.accdetlist_infobar);
        
        ListView listView = (ListView)findViewById(Res.id.accdetlist_list);
...
//        detailListHelper.reloadData(idp.listAllDetail());
        GUIs.doBusy(this,new GUIs.BusyAdapter() {
            ...
            public void onBusyFinish() {
                ...
                infoView.setText(info + i18n.string(Res.string.label_count,count));
            }
        });    
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(Res.menu.accdetlist_optmenu, menu);
        return true;
    }
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        ...
        if (v.getId() == Res.id.accdetlist_list) {
            getMenuInflater().inflate(Res.menu.accdetlist_ctxmenu, menu);
        }
